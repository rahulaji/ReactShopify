              ...
              <div className="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">  
                    <div className="col mb-5">
                        <div className="card h-100">
                            ...
                            <div className="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                {
                                     toggle1?<div className="text-center"><button className="btn btn-outline-dark mt-auto" 
                    ...
                    <div className="col mb-5">
                        <div className="card h-100">
                            ...
                            <div className="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            {
                                     toggle2?<div className="text-center"><button className="btn btn-outline-dark mt-auto" 
                                     onClick={()=>{setCartValue(cartValue+1)
                                                settoggle2(!toggle2)
                                    }}>Add to cart</button></div>
                                    :<div className="text-center"><button className="btn btn-outline-dark mt-auto" 
                    ...
                    <div className="col mb-5">
                        <div className="card h-100">
                            ...
                            <div className="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            {
                                     toggle3?<div className="text-center"><button className="btn btn-outline-dark mt-auto" 
                                     onClick={()=>{setCartValue(cartValue+1)
                                                settoggle3(!toggle3)
                                    }}>Add to cart</button></div>
                                    :<div className="text-center"><button className="btn btn-outline-dark mt-auto" 
